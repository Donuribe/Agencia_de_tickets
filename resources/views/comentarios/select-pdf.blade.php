...
@section('title','Seleccionar Comentario para Descargar PDF')
                ...
                <div class="col-md-10 offset-md-1">
                    <div class="card">
                        <div class="card-header" style="background-color: #17a2b8; color: white; font-size: 1.3rem; font-weight: 500; padding: 1rem;">
                            <i class="fas fa-file-pdf"></i> Seleccionar Comentario para Descargar PDF
                        </div>
                        <div class="card-body" style="padding: 2rem;">
                            ...
                            <div style="margin-bottom: 2rem;">
                                <a href="{{ route('comentarios.exportPdf', 'all') }}" class="btn btn-success btn-block" style="padding: 1rem; font-size: 1.1rem; border-radius: 0.5rem;">
                            ...
                            <!-- Grid de Comentarios 2 columnas -->
                            <div class="row">
                                @forelse($comentarios as $comentario)
                                <div class="col-md-6 mb-3">
                                    <div class="card" style="border: 2px solid #e3f2fd; border-radius: 0.5rem; background-color: #f8f9fa; transition: all 0.3s ease;">
                                        <div class="card-body" style="padding: 1.25rem; display: flex; justify-content: space-between; align-items: center;">
                                            <div style="flex-grow: 1;">
                                                <h5 style="color: #1976d2; font-weight: 600; margin-bottom: 0.5rem;">
                                                    {{ \Illuminate\Support\Str::limit($comentario->mensaje, 40) }}
                                                </h5>
                                                <p style="color: #999; font-size: 0.9rem; margin-bottom: 0.25rem;">
                                                    ID: {{ $comentario->id }}
                                                </p>
                                                <p style="color: #999; font-size: 0.85rem; margin-bottom: 0.25rem;">
                                                    Ticket: {{ $comentario->ticket->titulo ?? 'N/A' }}
                                                </p>
                            ...
                            <nav aria-label="Page navigation" style="margin-top: 2.5rem; display: flex; justify-content: center;">
                                <ul class="pagination" style="margin: 0; gap: 0.5rem; display: flex; align-items: center; list-style: none; padding: 0;">
                                    ...
                                    @else
                                        <li>
                                            <a href="{{ $comentarios->previousPageUrl() }}" style="padding: 0.6rem 0.85rem; border: 1px solid #1976d2; border-radius: 0.35rem; color: #1976d2; background-color: white; text-decoration: none; display: inline-block; font-size: 0.9rem; transition: all 0.3s ease; font-weight: 500;"
                                    ...
                                    {{-- Page Numbers --}}
                                    @foreach ($comentarios->getUrlRange(1, $comentarios->lastPage()) as $page => $url)
                                        @if ($page == $comentarios->currentPage())
                                            <li>
                                    ...
                                    @if ($comentarios->hasMorePages())
                                        <li>
                                            <a href="{{ $comentarios->nextPageUrl() }}" style="padding: 0.6rem 0.85rem; border: 1px solid #1976d2; border-radius: 0.35rem; color: #1976d2; background-color: white; text-decoration: none; display: inline-block; font-size: 0.9rem; transition: all 0.3s ease; font-weight: 500;"
                                               onmouseover="this.style.backgroundColor='#1976d2'; this.style.color='white'; this.style.boxShadow='0 2px 6px rgba(25, 118, 210, 0.3)';"
                                               onmouseout="this.style.backgroundColor='white'; this.style.color='#1976d2'; this.style.boxShadow='none';">
