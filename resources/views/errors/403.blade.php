...
<style>
    ...
    *{
    ...
    .btn-home:hover{
        ...
        color: white;
        box-shadow: 0 10px 30px rgba(217,119,6,.65);
    }
...
<div class="error-wrapper">
    ...
    <div class="error-card">
        ...
        <div class="error-text">
            No cuentas con permisos para ingresar a esta sección.
            Si consideras que esto es un error, comunícate con el administrador del sistema.
        </div>
